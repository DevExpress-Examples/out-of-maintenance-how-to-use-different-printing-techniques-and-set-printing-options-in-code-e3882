...
Namespace RichEdit_PrintingSystem
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			' pageSetupBar1
			' 
			Me.pageSetupBar1.Control = Me.richEditControl1
			...
			' documentViewsBar1
			' 
			Me.documentViewsBar1.Control = Me.richEditControl1
			...
			' showBar1
			' 
			Me.showBar1.Control = Me.richEditControl1
			...
			' zoomBar1
			' 
			Me.zoomBar1.Control = Me.richEditControl1
